        ...
        <div className="text-center space-y-6 max-w-3xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
            <button
              ...
              className="px-6 py-3.5 bg-[#24292f] hover:bg-[#1b1f23] text-white text-xs font-bold rounded-2xl flex items-center gap-2.5 shadow-sm active:scale-95 transition-transform cursor-pointer"
            >
            ...
            <button
              ...
              className="px-6 py-3.5 bg-[#ccee22] hover:bg-[#b8dd11] text-[#1c1917] text-xs font-bold rounded-2xl flex items-center gap-2 shadow-xs active:scale-95 transition-transform cursor-pointer"
            >
