...
export const BugIcon: React.FC<IconProps> = ({ className = 'w-4 h-4', size }) => (
  <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const BoardIcon: React.FC<IconProps> = ({ className = 'w-4 h-4', size }) => (
  <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const ReleaseIcon: React.FC<IconProps> = ({ className = 'w-4 h-4', size }) => (
  <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const SparklesIcon: React.FC<IconProps> = ({ className = 'w-4 h-4', size }) => (
  <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const IntegrationIcon: React.FC<IconProps> = ({ className = 'w-4 h-4', size }) => (
  <svg width={size} height={size} className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M9 12a4 4 0 1 0 4 4V4a5 5 0 0 0-5 5" />
    <path d="M15 12a4 4 0 1 0-4-4v12a5 5 0 0 0 5-5" />
  </svg>
);
